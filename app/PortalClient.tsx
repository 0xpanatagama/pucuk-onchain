...
function ReceiptView({ role, state, paid, disputed, onPay, onDispute }: { role: Role; state: ReceiptState; paid: boolean; disputed: boolean; onPay: () => void; onDispute: () => void }) {
